---
source_url: https://docs.appian.com/suite/help/25.3/Document_and_Folder_Picker_Component.html
original_path: Document_and_Folder_Picker_Component.html
version: "25.3"
title: "Document and Folder Picker Component"
page_id: "Document_and_Folder_Picker_Component"
section: "Function"
...
**a!pickerFieldDocumentsAndFolders**( _label, labelPosition, instructions, required, requiredMessage, readOnly, disabled, maxSelections, folderFilter, value, validations, validationGroup, saveInto, placeholder, helpTooltip, accessibilityText, showWhen, marginAbove, marginBelow_ )
...
When present, only documents and folders that are inside this folder and its subfolders are suggested.
...
_List of Document or Folder_

 |

Array of currently selected documents and folders.
...
One or more variables that are updated with the array of selected documents and folders when the user selects or removes a document or folder. Use a!save() to save a modified or alternative value to a variable.
