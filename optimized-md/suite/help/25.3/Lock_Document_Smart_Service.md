---
source_url: https://docs.appian.com/suite/help/25.3/Lock_Document_Smart_Service.html
original_path: Lock_Document_Smart_Service.html
version: "25.3"
title: "Lock Document Smart Service"
page_id: "Lock_Document_Smart_Service"
section: "Overview"
...
-   **Icon**: ![](images/Smart_Service_Icons/Lock_Document.png)
...
The [Lock Document smart service](#) is available as an expression function that can be executed inside a saveInto on a [Interface Component](executing_smart_services.html) or as part of a [Web API](Web_APIs.html).

### Syntax

**a!lockDocument**( _document, onSuccess, onError_ )
