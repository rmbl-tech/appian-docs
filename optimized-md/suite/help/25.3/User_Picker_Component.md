---
source_url: https://docs.appian.com/suite/help/25.3/User_Picker_Component.html
original_path: User_Picker_Component.html
version: "25.3"
title: "User Picker Component"
page_id: "User_Picker_Component"
section: "Function"
...
**a!pickerFieldUsers**( _label, instructions, required, requiredMessage, readOnly, disabled, maxSelections, groupFilter, value, validations, validationGroup, saveInto, labelPosition, placeholder, helpTooltip, accessibilityText, showWhen, marginAbove, marginBelow_ )
...
One or more variables that are updated with the array of selected users when the user selects or removes a user. Use a!save() to save a modified or alternative value to a variable.
...
-   All user members are suggested when _groupFilter_ is used, including users who are members of member groups and users who are members by rule.
...
The following patterns include usage of the User Picker Component.
