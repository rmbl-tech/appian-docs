---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/common/exceptions/InvalidAttachmentException.html
original_path: api/com/appiancorp/suiteapi/common/exceptions/InvalidAttachmentException.html
version: "25.3"
title: "Class InvalidAttachmentException"
page_id: "api/com/appiancorp/suiteapi/common/exceptions/InvalidAttachmentException"
...
com.appiancorp.suiteapi.common.exceptions.InvalidAttachmentException
...
public class InvalidAttachmentException extends [AppianException](../../../exceptions/AppianException.html "class in com.appiancorp.exceptions")

Exception that is thrown if the user references an attachment that does not exist in the database.

See Also:

-   [Serialized Form](../../../../../serialized-form.html#com.appiancorp.suiteapi.common.exceptions.InvalidAttachmentException)
...
-   ## Constructor Summary
    ...
    `[InvalidAttachmentException](#%3Cinit%3E\(\))()`

    Constructs a new exception with `null` as its detail message.

    `[InvalidAttachmentException](#%3Cinit%3E\(java.lang.String\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_)`

    Constructs a new exception with the specified detail message.

    `[InvalidAttachmentException](#%3Cinit%3E\(java.lang.String,java.lang.Throwable\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_, [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t_)`

    Constructs a new exception with the specified detail message and cause.

    `[InvalidAttachmentException](#%3Cinit%3E\(java.lang.Throwable\))([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t_)`
...
-   ## Constructor Details
    ...
    -   ### InvalidAttachmentException
        ...
        public InvalidAttachmentException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_)
    ...
    -   ### InvalidAttachmentException
        ...
        public InvalidAttachmentException([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)
    ...
    -   ### InvalidAttachmentException
        ...
        public InvalidAttachmentException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_, [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)
