---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/common/exceptions/InvalidPageException.html
original_path: api/com/appiancorp/suiteapi/common/exceptions/InvalidPageException.html
version: "25.3"
title: "Class InvalidPageException"
page_id: "api/com/appiancorp/suiteapi/common/exceptions/InvalidPageException"
...
com.appiancorp.suiteapi.common.exceptions.InvalidPageException
...
public class InvalidPageException extends [AppianException](../../../exceptions/AppianException.html "class in com.appiancorp.exceptions")

Thrown when a page id is used that does not refer to an existing page. This may be caused by concurrent deletion of the corresponding page.

See Also:

-   [Serialized Form](../../../../../serialized-form.html#com.appiancorp.suiteapi.common.exceptions.InvalidPageException)
...
-   ## Constructor Summary
    ...
    `[InvalidPageException](#%3Cinit%3E\(\))()`

    Constructs a new exception with `null` as its detail message.

    `[InvalidPageException](#%3Cinit%3E\(java.lang.String\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_)`
    ...
    `[InvalidPageException](#%3Cinit%3E\(java.lang.Throwable\))([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t_)`
...
-   ## Constructor Details
    ...
    -   ### InvalidPageException
        ...
        public InvalidPageException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_)
    ...
    -   ### InvalidPageException
        ...
        public InvalidPageException([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)
    ...
    -   ### InvalidPageException
        ...
        public InvalidPageException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_, [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)
