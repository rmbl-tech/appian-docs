---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/common/exceptions/InvalidPortletTypeException.html
original_path: api/com/appiancorp/suiteapi/common/exceptions/InvalidPortletTypeException.html
version: "25.3"
title: "Class InvalidPortletTypeException"
page_id: "api/com/appiancorp/suiteapi/common/exceptions/InvalidPortletTypeException"
...
# Class InvalidPortletTypeException
...
com.appiancorp.suiteapi.common.exceptions.InvalidPortletTypeException
...
public class InvalidPortletTypeException extends [AppianException](../../../exceptions/AppianException.html "class in com.appiancorp.exceptions")

Thrown when a portlet type id is used that does not refer to an existing portlet type.

See Also:

-   [Serialized Form](../../../../../serialized-form.html#com.appiancorp.suiteapi.common.exceptions.InvalidPortletTypeException)
...
-   ## Constructor Summary
    ...
    `[InvalidPortletTypeException](#%3Cinit%3E\(\))()`

    Constructs a new exception with `null` as its detail message.

    `[InvalidPortletTypeException](#%3Cinit%3E\(java.lang.String\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_)`
    ...
    `[InvalidPortletTypeException](#%3Cinit%3E\(java.lang.Throwable\))([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t_)`
...
-   ## Constructor Details
    ...
    -   ### InvalidPortletTypeException
        ...
        public InvalidPortletTypeException()

        Constructs a new exception with `null` as its detail message. The cause is not initialized, and may subsequently be initialized by a call to Throwable.initCause(java.lang.Throwable)

    -   ### InvalidPortletTypeException

        public InvalidPortletTypeException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_)
    ...
    -   ### InvalidPortletTypeException
        ...
        public InvalidPortletTypeException([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)
    ...
    -   ### InvalidPortletTypeException
        ...
        public InvalidPortletTypeException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_, [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)
