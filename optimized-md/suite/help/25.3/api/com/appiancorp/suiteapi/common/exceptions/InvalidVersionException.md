---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/common/exceptions/InvalidVersionException.html
original_path: api/com/appiancorp/suiteapi/common/exceptions/InvalidVersionException.html
version: "25.3"
title: "Class InvalidVersionException"
page_id: "api/com/appiancorp/suiteapi/common/exceptions/InvalidVersionException"
...
com.appiancorp.suiteapi.common.exceptions.InvalidVersionException
...
public class InvalidVersionException extends [AppianException](../../../exceptions/AppianException.html "class in com.appiancorp.exceptions")
...
-   [Serialized Form](../../../../../serialized-form.html#com.appiancorp.suiteapi.common.exceptions.InvalidVersionException)
...
-   ## Constructor Summary
    ...
    `[InvalidVersionException](#%3Cinit%3E\(\))()`

    Constructs a new InvalidVersionException with null as its detail message.

    `[InvalidVersionException](#%3Cinit%3E\(java.lang.String\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_)`

    Constructs a new InvalidVersionException with the specified detail message.

    `[InvalidVersionException](#%3Cinit%3E\(java.lang.String,java.lang.Throwable\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_, [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t_)`

    Constructs a new InvalidVersionException with the specified detail message and cause.

    `[InvalidVersionException](#%3Cinit%3E\(java.lang.Throwable\))([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t_)`
...
-   ## Constructor Details
    ...
    -   ### InvalidVersionException
        ...
        Constructs a new InvalidVersionException with null as its detail message. The cause is not initialized, and may subsequently be initialized by a call to Throwable.initCause(java.lang.Throwable)

    -   ### InvalidVersionException

        public InvalidVersionException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_)

        Constructs a new InvalidVersionException with the specified detail message. The cause is not initialized, and may subsequently be initialized by a call to Throwable.initCause(java.lang.Throwable)
    ...
    -   ### InvalidVersionException
        ...
        public InvalidVersionException([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)
    ...
    -   ### InvalidVersionException
        ...
        public InvalidVersionException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_, [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)

        Constructs a new InvalidVersionException with the specified detail message and cause. Note that the detail message associated with cause is not automatically incorporated in this exception's detail message.
