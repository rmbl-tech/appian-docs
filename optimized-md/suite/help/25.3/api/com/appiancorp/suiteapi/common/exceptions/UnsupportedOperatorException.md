---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/common/exceptions/UnsupportedOperatorException.html
original_path: api/com/appiancorp/suiteapi/common/exceptions/UnsupportedOperatorException.html
version: "25.3"
title: "Class UnsupportedOperatorException"
page_id: "api/com/appiancorp/suiteapi/common/exceptions/UnsupportedOperatorException"
...
com.appiancorp.suiteapi.common.exceptions.UnsupportedOperatorException
...
public class UnsupportedOperatorException extends [AppianException](../../../exceptions/AppianException.html "class in com.appiancorp.exceptions")

Thrown when a given operator is not supported by the Personalization service.

See Also:

-   [Serialized Form](../../../../../serialized-form.html#com.appiancorp.suiteapi.common.exceptions.UnsupportedOperatorException)
...
-   ## Constructor Summary
    ...
    `[UnsupportedOperatorException](#%3Cinit%3E\(\))()`

    Constructs a new exception with `null` as its detail message.

    `[UnsupportedOperatorException](#%3Cinit%3E\(java.lang.String\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_)`

    Constructs a new exception with the specified detail message.

    `[UnsupportedOperatorException](#%3Cinit%3E\(java.lang.String,java.lang.Throwable\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_, [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t_)`

    Constructs a new exception with the specified detail message and cause.

    `[UnsupportedOperatorException](#%3Cinit%3E\(java.lang.Throwable\))([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t_)`
...
-   ## Constructor Details
    ...
    -   ### UnsupportedOperatorException
        ...
        public UnsupportedOperatorException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_)
    ...
    -   ### UnsupportedOperatorException
        ...
        public UnsupportedOperatorException([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)
    ...
    -   ### UnsupportedOperatorException
        ...
        public UnsupportedOperatorException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_, [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)
