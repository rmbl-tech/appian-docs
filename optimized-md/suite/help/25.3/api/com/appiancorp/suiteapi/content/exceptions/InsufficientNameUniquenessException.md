---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/content/exceptions/InsufficientNameUniquenessException.html
original_path: api/com/appiancorp/suiteapi/content/exceptions/InsufficientNameUniquenessException.html
version: "25.3"
title: "Class InsufficientNameUniquenessException"
page_id: "api/com/appiancorp/suiteapi/content/exceptions/InsufficientNameUniquenessException"
...
# Class InsufficientNameUniquenessException
...
public class InsufficientNameUniquenessException extends [AppianException](../../../exceptions/AppianException.html "class in com.appiancorp.exceptions")
...
-   [Serialized Form](../../../../../serialized-form.html#com.appiancorp.suiteapi.content.exceptions.InsufficientNameUniquenessException)
...
-   ## Constructor Summary
    ...
    `[InsufficientNameUniquenessException](#%3Cinit%3E\(\))()`

    Constructs a new InsufficientNameUniquenessException with null as its detail message.

    `[InsufficientNameUniquenessException](#%3Cinit%3E\(java.lang.String\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_)`
    ...
    `[InsufficientNameUniquenessException](#%3Cinit%3E\(java.lang.Throwable\))([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t_)`
...
-   ## Constructor Details
    ...
    -   ### InsufficientNameUniquenessException
        ...
        Constructs a new InsufficientNameUniquenessException with null as its detail message. The cause is not initialized, and may subsequently be initialized by a call to Throwable.initCause(java.lang.Throwable)

    -   ### InsufficientNameUniquenessException

        public InsufficientNameUniquenessException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_)

        Constructs a new InsufficientNameUniquenessException with the specified detail message. The cause is not initialized, and may subsequently be initialized by a call to Throwable.initCause(java.lang.Throwable)
    ...
    -   ### InsufficientNameUniquenessException
        ...
        public InsufficientNameUniquenessException([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)

        Constructs a new InsufficientNameUniquenessException with the specified cause and a detail message of (cause==null ? null : cause.toString()) (which typically contains the class and detail message of cause). This constructor is useful for exceptions that are little more than wrappers for other throwables (for example, PrivilegedActionException)
    ...
    -   ### InsufficientNameUniquenessException
        ...
        public InsufficientNameUniquenessException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_, [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)

        Constructs a new InsufficientNameUniquenessException with the specified detail message and cause. Note that the detail message associated with cause is not automatically incorporated in this exception's detail message.
