---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/content/exceptions/InvalidTypeMaskException.html
original_path: api/com/appiancorp/suiteapi/content/exceptions/InvalidTypeMaskException.html
version: "25.3"
title: "Class InvalidTypeMaskException"
page_id: "api/com/appiancorp/suiteapi/content/exceptions/InvalidTypeMaskException"
...
public class InvalidTypeMaskException extends [AppianException](../../../exceptions/AppianException.html "class in com.appiancorp.exceptions")

This exception may be thrown by service methods if they detect that the type mask provided is invalid. The type mask provided may be in a [`ContentFilter`](../ContentFilter.html "class in com.appiancorp.suiteapi.content").

See Also:

-   [Serialized Form](../../../../../serialized-form.html#com.appiancorp.suiteapi.content.exceptions.InvalidTypeMaskException)
...
-   ## Constructor Summary
    ...
    `[InvalidTypeMaskException](#%3Cinit%3E\(\))()`

    Constructs a new InvalidTypeMaskException with null as its detail message.

    `[InvalidTypeMaskException](#%3Cinit%3E\(java.lang.String\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_)`

    Constructs a new InvalidTypeMaskException with the specified detail message.

    `[InvalidTypeMaskException](#%3Cinit%3E\(java.lang.String,java.lang.Throwable\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_, [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t_)`

    Constructs a new InvalidTypeMaskException with the specified detail message and cause.

    `[InvalidTypeMaskException](#%3Cinit%3E\(java.lang.Throwable\))([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t_)`
...
-   ## Constructor Details
    ...
    -   ### InvalidTypeMaskException
        ...
        public InvalidTypeMaskException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_)
    ...
    -   ### InvalidTypeMaskException
        ...
        public InvalidTypeMaskException([Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)
    ...
    -   ### InvalidTypeMaskException
        ...
        public InvalidTypeMaskException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_, [Throwable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Throwable.html "class or interface in java.lang") t\_)
