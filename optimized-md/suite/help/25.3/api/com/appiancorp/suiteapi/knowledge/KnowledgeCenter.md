---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/knowledge/KnowledgeCenter.html
original_path: api/com/appiancorp/suiteapi/knowledge/KnowledgeCenter.html
version: "25.3"
title: "Class KnowledgeCenter"
page_id: "api/com/appiancorp/suiteapi/knowledge/KnowledgeCenter"
...
com.appiancorp.suiteapi.knowledge.KnowledgeCenter
...
`[CommunityKnowledgeCenter](CommunityKnowledgeCenter.html "class in com.appiancorp.suiteapi.knowledge")`, `[PersonalKnowledgeCenter](PersonalKnowledgeCenter.html "class in com.appiancorp.suiteapi.knowledge")`

* * *

[@KnowledgeCenterDataType](KnowledgeCenterDataType.html "annotation interface in com.appiancorp.suiteapi.knowledge") public abstract class KnowledgeCenter extends [Container](../content/Container.html "class in com.appiancorp.suiteapi.content")

Represents a knowledge center. Knowledge centers can contain [`KnowledgeFolder`](KnowledgeFolder.html "class in com.appiancorp.suiteapi.knowledge")} items. When constructing a knowledge center, you must specifically construct a [`CommunityKnowledgeCenter`](CommunityKnowledgeCenter.html "class in com.appiancorp.suiteapi.knowledge") or a [`PersonalKnowledgeCenter`](PersonalKnowledgeCenter.html "class in com.appiancorp.suiteapi.knowledge"), which are actually different types.

See Also:

-   [Serialized Form](../../../../serialized-form.html#com.appiancorp.suiteapi.knowledge.KnowledgeCenter)
...
-   ## Field Summary
    ...
    `[accessStatus$TRANSIENT](#accessStatus$TRANSIENT)`
...
-   ## Constructor Summary
    ...
    `[KnowledgeCenter](#%3Cinit%3E\(int\))(int type_)`

    Constructs a new knowledge center.

    `protected`

    `[KnowledgeCenter](#%3Cinit%3E\(java.lang.Integer\))([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") type_)`
...
-   ## Method Summary
    ...
    `[isRequiresAccessApproval](#isRequiresAccessApproval\(\))()`
    ...
    `[setAccessStatus](#setAccessStatus\(java.lang.Integer\))([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") accessStatus)`

    Sets the access status for the content (only valid for the user who retrieved it).

    `void`

    `[setExpirationDays](#setExpirationDays\(java.lang.Integer\))([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") expirationDays)`

    Sets the number of days until content expires.

    `void`

    `[setRequiresAccessApproval](#setRequiresAccessApproval\(boolean\))(boolean requiresAccessApproval)`

    Sets whether users require administrator approval for access to this Knowledge Center

    `void`

    `[setSearchable](#setSearchable\(boolean\))(boolean isSearchable)`
...
-   ## Field Details
    ...
    -   ### accessStatus$TRANSIENT
        ...
        -   [Constant Field Values](../../../../constant-values.html#com.appiancorp.suiteapi.knowledge.KnowledgeCenter.accessStatus$TRANSIENT)
...
-   ## Constructor Details
    ...
    -   ### KnowledgeCenter
        ...
        Constructs a new knowledge center. Sets the partition to [`ContentConstants.ALLOCATE_GLOBAL_PART`](../content/ContentConstants.html#ALLOCATE_GLOBAL_PART), which tell the database to automatically assign a partition to the knowledge center. Adds [`ContentConstants.SEC_INH_ADMIN`](../content/ContentConstants.html#SEC_INH_ADMIN) and [`ContentConstants.SEC_CREATOR_ADMIN`](../content/ContentConstants.html#SEC_CREATOR_ADMIN) to security.

    -   ### KnowledgeCenter

        protected KnowledgeCenter(int type\_)
    ...
    -   ### KnowledgeCenter
        ...
        protected KnowledgeCenter([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") type\_)
...
-   ## Method Details
    ...
    -   ### getExpirationDays
        ...
        public [Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") getExpirationDays()
    ...
    -   ### setExpirationDays
        ...
        public void setExpirationDays([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") expirationDays)
    ...
    -   ### getAccessStatus
        ...
        public [Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") getAccessStatus()
        ...
        -   [`setAccessStatus(Integer)`](#setAccessStatus\(java.lang.Integer\))

    -   ### setAccessStatus

        public void setAccessStatus([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") accessStatus)
