---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/process/events/EventProducerReturnConverter.html
original_path: api/com/appiancorp/suiteapi/process/events/EventProducerReturnConverter.html
version: "25.3"
title: "Class EventProducerReturnConverter"
page_id: "api/com/appiancorp/suiteapi/process/events/EventProducerReturnConverter"
...
# Class EventProducerReturnConverter

[java.lang.Object](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Object.html "class or interface in java.lang")

com.appiancorp.kougar.mapper.returns.AbstractReturnConverter

com.appiancorp.suiteapi.process.events.EventProducerReturnConverter
...
[@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html "class or interface in java.lang") public class EventProducerReturnConverter extends com.appiancorp.kougar.mapper.returns.AbstractReturnConverter implements com.appiancorp.kougar.mapper.returns.FromNull, com.appiancorp.kougar.mapper.returns.FromDictionary

Deprecated.

Return converter for converting data from the database format to an [`EventProducer`](EventProducer.html "class in com.appiancorp.suiteapi.process.events") object. Used when data is returned from a database API method.
...
-   ## Constructor Summary
    ...
    `[EventProducerReturnConverter](#%3Cinit%3E\(\))()`
...
-   ## Method Summary
    ...
    Converts `null` to an [`EventProducer`](EventProducer.html "class in com.appiancorp.suiteapi.process.events") object.
    ...
    Converts the database-format data to an [`EventProducer`](EventProducer.html "class in com.appiancorp.suiteapi.process.events") object.
    ...
    Gets the class that it can convert to ([`EventProducer`](EventProducer.html "class in com.appiancorp.suiteapi.process.events")).
...
-   ## Constructor Details
    ...
    -   ### EventProducerReturnConverter
        ...
        public EventProducerReturnConverter()
...
-   ## Method Details
    ...
    -   ### convert
        ...
        Converts `null` to an [`EventProducer`](EventProducer.html "class in com.appiancorp.suiteapi.process.events") object. This method always returns `null`.
    ...
    -   ### convert
        ...
        the new [`EventProducer`](EventProducer.html "class in com.appiancorp.suiteapi.process.events") object
