---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/process/exceptions/InvalidProcessVariableNameException.html
original_path: api/com/appiancorp/suiteapi/process/exceptions/InvalidProcessVariableNameException.html
version: "25.3"
title: "Class InvalidProcessVariableNameException"
page_id: "api/com/appiancorp/suiteapi/process/exceptions/InvalidProcessVariableNameException"
...
com.appiancorp.suiteapi.process.exceptions.InvalidProcessVariableNameException
...
public class InvalidProcessVariableNameException extends [AppianException](../../../exceptions/AppianException.html "class in com.appiancorp.exceptions")

Exception that is thrown if the user calls a method with a process variable name that does not match any variable in the database. Mostly thrown by methods on [`ProcessExecutionService`](../ProcessExecutionService.html "interface in com.appiancorp.suiteapi.process").

See Also:

-   [Serialized Form](../../../../../serialized-form.html#com.appiancorp.suiteapi.process.exceptions.InvalidProcessVariableNameException)
...
-   ## Constructor Summary
    ...
    `[InvalidProcessVariableNameException](#%3Cinit%3E\(\))()`

    Constructs a new exception with `null` as its detail message.

    `[InvalidProcessVariableNameException](#%3Cinit%3E\(java.lang.String\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_)`
...
-   ## Constructor Details
    ...
    -   ### InvalidProcessVariableNameException
        ...
        public InvalidProcessVariableNameException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_)
