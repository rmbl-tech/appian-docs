---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/process/exceptions/ReportComplexityException.html
original_path: api/com/appiancorp/suiteapi/process/exceptions/ReportComplexityException.html
version: "25.3"
title: "Class ReportComplexityException"
page_id: "api/com/appiancorp/suiteapi/process/exceptions/ReportComplexityException"
...
# Class ReportComplexityException
...
com.appiancorp.suiteapi.process.exceptions.ReportComplexityException
...
public class ReportComplexityException extends [AppianException](../../../exceptions/AppianException.html "class in com.appiancorp.exceptions")

This exception is thrown if the expression is too complex.

See Also:

-   [Serialized Form](../../../../../serialized-form.html#com.appiancorp.suiteapi.process.exceptions.ReportComplexityException)
...
-   ## Constructor Summary
    ...
    `[ReportComplexityException](#%3Cinit%3E\(\))()`

    Constructs a new exception with `null` as its detail message.

    `[ReportComplexityException](#%3Cinit%3E\(java.lang.String\))([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message_)`
...
-   ## Constructor Details
    ...
    -   ### ReportComplexityException
        ...
        public ReportComplexityException()

        Constructs a new exception with `null` as its detail message. The cause is not initialized, and may subsequently be initialized by a call to Throwable.initCause(java.lang.Throwable)

    -   ### ReportComplexityException

        public ReportComplexityException([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") message\_)
