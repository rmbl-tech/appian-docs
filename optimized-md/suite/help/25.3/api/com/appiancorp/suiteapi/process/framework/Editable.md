---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/process/framework/Editable.html
original_path: api/com/appiancorp/suiteapi/process/framework/Editable.html
version: "25.3"
title: "Enum Class Editable"
page_id: "api/com/appiancorp/suiteapi/process/framework/Editable"
...
[java.lang.Enum](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html "class or interface in java.lang")<[Editable](Editable.html "enum class in com.appiancorp.suiteapi.process.framework")\>

com.appiancorp.suiteapi.process.framework.Editable

All Implemented Interfaces:

`[Serializable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/io/Serializable.html "class or interface in java.io")`, `[Comparable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Comparable.html "class or interface in java.lang")<[Editable](Editable.html "enum class in com.appiancorp.suiteapi.process.framework")>`, `[Constable](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/constant/Constable.html "class or interface in java.lang.constant")`

* * *

public enum Editable extends [Enum](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Enum.html "class or interface in java.lang")<[Editable](Editable.html "enum class in com.appiancorp.suiteapi.process.framework")\>
...
-   ## Method Summary
    ...
    `static [Editable](Editable.html "enum class in com.appiancorp.suiteapi.process.framework")`
...
-   ## Enum Constant Details
    ...
    -   ### NEVER
        ...
        public static final [Editable](Editable.html "enum class in com.appiancorp.suiteapi.process.framework") NEVER

    -   ### ALWAYS

        public static final [Editable](Editable.html "enum class in com.appiancorp.suiteapi.process.framework") ALWAYS

    -   ### DESIGNER

        public static final [Editable](Editable.html "enum class in com.appiancorp.suiteapi.process.framework") DESIGNER

-   ## Method Details

    -   ### values

        public static [Editable](Editable.html "enum class in com.appiancorp.suiteapi.process.framework")\[\] values()
    ...
    -   ### valueOf
        ...
        public static [Editable](Editable.html "enum class in com.appiancorp.suiteapi.process.framework") valueOf([String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") name)
