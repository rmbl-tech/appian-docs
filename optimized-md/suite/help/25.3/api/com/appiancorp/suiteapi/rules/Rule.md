---
source_url: https://docs.appian.com/suite/help/25.3/api/com/appiancorp/suiteapi/rules/Rule.html
original_path: api/com/appiancorp/suiteapi/rules/Rule.html
version: "25.3"
title: "Class Rule"
page_id: "api/com/appiancorp/suiteapi/rules/Rule"
...
`[Constant](Constant.html "class in com.appiancorp.suiteapi.rules")`, `[FreeformRule](FreeformRule.html "class in com.appiancorp.suiteapi.rules")`

* * *

public abstract class Rule extends [Content](../content/Content.html "class in com.appiancorp.suiteapi.content")

Represents a rule or a constant in rules (constants are actually a special case of rules). This is abstract because you should create a new rule using either [`FreeformRule`](FreeformRule.html "class in com.appiancorp.suiteapi.rules") or [`Constant`](Constant.html "class in com.appiancorp.suiteapi.rules").

See Also:

-   [Serialized Form](../../../../serialized-form.html#com.appiancorp.suiteapi.rules.Rule)
...
-   ## Field Summary
    ...
    `[multiple$TRANSIENT](#multiple$TRANSIENT)`

    `static final boolean`

    `[returnType$TRANSIENT](#returnType$TRANSIENT)`
...
-   ## Constructor Summary
    ...
    `[Rule](#%3Cinit%3E\(int\))(int subtype_)`

    Constructs a new rule.

    `protected`

    `[Rule](#%3Cinit%3E\(java.lang.Integer\))([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") subtype_)`
...
-   ## Method Summary
    ...
    use [`Constant.getTypedValue()`](Constant.html#getTypedValue\(\))
    ...
    use [`Constant.setTypedValue(com.appiancorp.suiteapi.type.TypedValue)`](Constant.html#setTypedValue\(com.appiancorp.suiteapi.type.TypedValue\))
    ...
    `[setMultiple](#setMultiple\(java.lang.Integer\))([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") multiple_)`
    ...
    `[setReturnType](#setReturnType\(long\))(long returnType_)`
    ...
    `[setReturnType](#setReturnType\(java.lang.Long\))([Long](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Long.html "class or interface in java.lang") returnType_)`
...
-   ## Field Details
    ...
    -   ### multiple$TRANSIENT
        ...
        public static final boolean multiple$TRANSIENT

        See Also:

        -   [Constant Field Values](../../../../constant-values.html#com.appiancorp.suiteapi.rules.Rule.multiple$TRANSIENT)

    -   ### returnType$TRANSIENT

        public static final boolean returnType$TRANSIENT

        See Also:

        -   [Constant Field Values](../../../../constant-values.html#com.appiancorp.suiteapi.rules.Rule.returnType$TRANSIENT)
...
-   ## Constructor Details
    ...
    -   ### Rule
        ...
        Constructs a new rule. Adds [`ContentConstants.SEC_CREATOR_ADMIN`](../content/ContentConstants.html#SEC_CREATOR_ADMIN), [`ContentConstants.SEC_PUBLIC`](../content/ContentConstants.html#SEC_PUBLIC), and [`ContentConstants.SEC_INH_ALL`](../content/ContentConstants.html#SEC_INH_ALL) to the security.

    -   ### Rule

        protected Rule(int subtype\_)

        Constructs a new rule. Adds [`ContentConstants.SEC_CREATOR_ADMIN`](../content/ContentConstants.html#SEC_CREATOR_ADMIN), [`ContentConstants.SEC_PUBLIC`](../content/ContentConstants.html#SEC_PUBLIC), and [`ContentConstants.SEC_INH_ALL`](../content/ContentConstants.html#SEC_INH_ALL) to the security.

        Parameters:

        `subtype_` - the subtype (one of [`ContentConstants.SUBTYPE_RULE_CONSTANT`](../content/ContentConstants.html#SUBTYPE_RULE_CONSTANT) or [`ContentConstants.SUBTYPE_RULE_FREEFORM`](../content/ContentConstants.html#SUBTYPE_RULE_FREEFORM))

    -   ### Rule

        protected Rule([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") subtype\_)
...
-   ## Method Details
    ...
    -   ### getReturnType
        ...
        [@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html "class or interface in java.lang") public [Long](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Long.html "class or interface in java.lang") getReturnType()

        Deprecated.

        use [`Constant.getTypedValue()`](Constant.html#getTypedValue\(\))

        Gets the type of data that this rule is expected to return. This is currently only set for constants, but could be manually set for other types of rules. This is not stored as a full-fledged field, but instead is stored as an attribute.
        ...
        -   [`setReturnType(Long)`](#setReturnType\(java.lang.Long\))

    -   ### setReturnType

        [@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html "class or interface in java.lang") public void setReturnType([Long](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Long.html "class or interface in java.lang") returnType\_)

        Deprecated.

        use [`Constant.setTypedValue(com.appiancorp.suiteapi.type.TypedValue)`](Constant.html#setTypedValue\(com.appiancorp.suiteapi.type.TypedValue\))

        Sets the type of data that this rule is expected to return. This is currently only set for constants, but could be manually set for other types of rules. This is not stored as a full-fledged field, but instead is stored as an attribute. This field can be updated in the database.

        Parameters:

        `returnType_` - the return type
    ...
    -   ### setReturnType
        ...
        [@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html "class or interface in java.lang") public void setReturnType(long returnType\_)

        Deprecated.

        use [`Constant.setTypedValue(com.appiancorp.suiteapi.type.TypedValue)`](Constant.html#setTypedValue\(com.appiancorp.suiteapi.type.TypedValue\))

        Sets the type of data that this rule is expected to return. This method actually calls [`setReturnType(Long)`](#setReturnType\(java.lang.Long\)). This field can be updated in the database.
    ...
    -   ### getMultiple
        ...
        [@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html "class or interface in java.lang") public [Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") getMultiple()

        Deprecated.

        use [`Constant.getTypedValue()`](Constant.html#getTypedValue\(\))

        Gets whether or not this rule can return multiple values. This is currently only set for constants, but could be manually set for other types of rules. This is not stored as a full-fledged field, but instead is stored as an attribute.

        Returns:

        whether this rule can return multiple values (0 for false, 1 for true)

        See Also:

        -   [`Content.getAttributes()`](../content/Content.html#getAttributes\(\))
        -   [`setMultiple(Integer)`](#setMultiple\(java.lang.Integer\))

    -   ### setMultiple

        [@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html "class or interface in java.lang") public void setMultiple([Integer](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Integer.html "class or interface in java.lang") multiple\_)

        Deprecated.

        use [`Constant.setTypedValue(com.appiancorp.suiteapi.type.TypedValue)`](Constant.html#setTypedValue\(com.appiancorp.suiteapi.type.TypedValue\))

        Sets whether or not this rule can return multiple values. This is currently only set for constants, but could be manually set for other types of rules. This is not stored as a full-fledged field, but instead is stored as an attribute. Can be 0 for false, 1 for true. This field can be updated in the database.

        Parameters:

        `multiple_` - whether this rule can return multiple values (0 for false, 1 for true)
    ...
    -   ### setMultiple
        ...
        [@Deprecated](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Deprecated.html "class or interface in java.lang") public void setMultiple(int multiple\_)

        Deprecated.

        use [`Constant.setTypedValue(com.appiancorp.suiteapi.type.TypedValue)`](Constant.html#setTypedValue\(com.appiancorp.suiteapi.type.TypedValue\))

        Sets whether or not this rule can return multiple values. This method actually calls [`setMultiple(Integer)`](#setMultiple\(java.lang.Integer\)).
    ...
    -   ### setMultiple
        ...
        Sets whether or not this rule can return multiple values. This method actually calls [`setMultiple(int)`](#setMultiple\(int\)) after converting the boolean to an Integer (0 for false, 1 for true). This field can be updated in the database.

        Parameters:

        `multiple_` - whether this rule can return multiple values
    ...
    -   ### getIcon
        ...
        public abstract [String](https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/String.html "class or interface in java.lang") getIcon()