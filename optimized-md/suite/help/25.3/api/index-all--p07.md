...
Returns a predicate that will return `true` when the [`field`](com/appiancorp/suiteapi/common/paging/SortInfo.html#getField\(\)) of a [`SortInfo`](com/appiancorp/suiteapi/common/paging/SortInfo.html "class in com.appiancorp.suiteapi.common.paging") object equals the given field name.
...
[FilterValidator](com/appiancorp/common/query/FilterValidator.html "interface in com.appiancorp.common.query") - Interface in [com.appiancorp.common.query](com/appiancorp/common/query/package-summary.html)
...
[findUsers$UPDATES](com/appiancorp/suiteapi/personalization/UserService.html#findUsers$UPDATES) - Static variable in interface com.appiancorp.suiteapi.personalization.[UserService](com/appiancorp/suiteapi/personalization/UserService.html "interface in com.appiancorp.suiteapi.personalization")
...
[FOLDERS](com/appiancorp/suiteapi/content/ContentFilter.html#FOLDERS) - Static variable in class com.appiancorp.suiteapi.content.[ContentFilter](com/appiancorp/suiteapi/content/ContentFilter.html "class in com.appiancorp.suiteapi.content")
...
[FORM\_TYPE\_DYNAMIC](com/appiancorp/suiteapi/process/forms/FormConfig.html#FORM_TYPE_DYNAMIC) - Static variable in class com.appiancorp.suiteapi.process.forms.[FormConfig](com/appiancorp/suiteapi/process/forms/FormConfig.html "class in com.appiancorp.suiteapi.process.forms")
...
[FORMAT\_NAME\_TIMEZONE](com/appiancorp/suiteapi/expression/LocaleDisplayFormat.html#FORMAT_NAME_TIMEZONE) - Static variable in class com.appiancorp.suiteapi.expression.[LocaleDisplayFormat](com/appiancorp/suiteapi/expression/LocaleDisplayFormat.html "class in com.appiancorp.suiteapi.expression")
...
[FORWARD\_SUCCESS](com/appiancorp/common/appianwebmvc/BaseAction.html#FORWARD_SUCCESS) - Static variable in class com.appiancorp.common.appianwebmvc.[BaseAction](com/appiancorp/common/appianwebmvc/BaseAction.html "class in com.appiancorp.common.appianwebmvc")
...
[FreeformRule()](com/appiancorp/suiteapi/rules/FreeformRule.html#%3Cinit%3E\(\)) - Constructor for class com.appiancorp.suiteapi.rules.[FreeformRule](com/appiancorp/suiteapi/rules/FreeformRule.html "class in com.appiancorp.suiteapi.rules")

Constructs a new freeform rule object.

[FreeformRule(int)](com/appiancorp/suiteapi/rules/FreeformRule.html#%3Cinit%3E\(int\)) - Constructor for class com.appiancorp.suiteapi.rules.[FreeformRule](com/appiancorp/suiteapi/rules/FreeformRule.html "class in com.appiancorp.suiteapi.rules")

[FROM\_DESIGN](com/appiancorp/suiteapi/expression/FunctionRequest.html#FROM_DESIGN) - Static variable in class com.appiancorp.suiteapi.expression.[FunctionRequest](com/appiancorp/suiteapi/expression/FunctionRequest.html "class in com.appiancorp.suiteapi.expression")

[FROM\_EXECUTION](com/appiancorp/suiteapi/expression/FunctionRequest.html#FROM_EXECUTION) - Static variable in class com.appiancorp.suiteapi.expression.[FunctionRequest](com/appiancorp/suiteapi/expression/FunctionRequest.html "class in com.appiancorp.suiteapi.expression")

[FROM\_JSON\_SERIALIZATION](com/appiancorp/suiteapi/common/exceptions/ErrorCode.html#FROM_JSON_SERIALIZATION) - Static variable in class com.appiancorp.suiteapi.common.exceptions.[ErrorCode](com/appiancorp/suiteapi/common/exceptions/ErrorCode.html "class in com.appiancorp.suiteapi.common.exceptions")

[fromFieldName(String)](com/appiancorp/type/system/ListViewItem.Field.html#fromFieldName\(java.lang.String\)) - Static method in enum class com.appiancorp.type.system.[ListViewItem.Field](com/appiancorp/type/system/ListViewItem.Field.html "enum class in com.appiancorp.type.system")

[fromThrowable(Locale)](com/appiancorp/exceptions/AppianErrorBuilder.html#fromThrowable\(java.util.Locale\)) - Static method in class com.appiancorp.exceptions.[AppianErrorBuilder](com/appiancorp/exceptions/AppianErrorBuilder.html "class in com.appiancorp.exceptions")

Returns a function to create [`AppianError`](com/appiancorp/exceptions/AppianError.html "class in com.appiancorp.exceptions")s from exceptions.

[fromThrowable(Locale, Throwable)](com/appiancorp/exceptions/AppianErrorBuilder.html#fromThrowable\(java.util.Locale,java.lang.Throwable\)) - Static method in class com.appiancorp.exceptions.[AppianErrorBuilder](com/appiancorp/exceptions/AppianErrorBuilder.html "class in com.appiancorp.exceptions")

Creates an [`AppianError`](com/appiancorp/exceptions/AppianError.html "class in com.appiancorp.exceptions") from the given exception, by applying the function generated by [`AppianErrorBuilder.fromThrowable(Locale)`](com/appiancorp/exceptions/AppianErrorBuilder.html#fromThrowable\(java.util.Locale\)).

[fromThrowable(Locale, Throwable, ErrorCode)](com/appiancorp/exceptions/AppianErrorBuilder.html#fromThrowable\(java.util.Locale,java.lang.Throwable,com.appiancorp.suiteapi.common.exceptions.ErrorCode\)) - Static method in class com.appiancorp.exceptions.[AppianErrorBuilder](com/appiancorp/exceptions/AppianErrorBuilder.html "class in com.appiancorp.exceptions")

Creates an [`AppianError`](com/appiancorp/exceptions/AppianError.html "class in com.appiancorp.exceptions") from the given exception, by applying the function generated by [`AppianErrorBuilder.fromThrowable(Locale)`](com/appiancorp/exceptions/AppianErrorBuilder.html#fromThrowable\(java.util.Locale\)).

[fromXML(Node)](com/appiancorp/suiteapi/process/forms/DynamicForm.html#fromXML\(org.w3c.dom.Node\)) - Static method in class com.appiancorp.suiteapi.process.forms.[DynamicForm](com/appiancorp/suiteapi/process/forms/DynamicForm.html "class in com.appiancorp.suiteapi.process.forms")

Creates a form from xml

[fromXML(Node)](com/appiancorp/suiteapi/process/forms/FormConfig.html#fromXML\(org.w3c.dom.Node\)) - Static method in class com.appiancorp.suiteapi.process.forms.[FormConfig](com/appiancorp/suiteapi/process/forms/FormConfig.html "class in com.appiancorp.suiteapi.process.forms")

Creates a form from xml

[fromXML(Node)](com/appiancorp/suiteapi/process/forms/FormElement.html#fromXML\(org.w3c.dom.Node\)) - Static method in class com.appiancorp.suiteapi.process.forms.[FormElement](com/appiancorp/suiteapi/process/forms/FormElement.html "class in com.appiancorp.suiteapi.process.forms")

Creates a form element from xml

[fromXML(Node)](com/appiancorp/suiteapi/process/forms/InternalForm.html#fromXML\(org.w3c.dom.Node\)) - Static method in class com.appiancorp.suiteapi.process.forms.[InternalForm](com/appiancorp/suiteapi/process/forms/InternalForm.html "class in com.appiancorp.suiteapi.process.forms")

Constructs an `InternalForm` from its XML representation

[fromXML(Node)](com/appiancorp/suiteapi/process/forms/JSPForm.html#fromXML\(org.w3c.dom.Node\)) - Static method in class com.appiancorp.suiteapi.process.forms.[JSPForm](com/appiancorp/suiteapi/process/forms/JSPForm.html "class in com.appiancorp.suiteapi.process.forms")

Constructs a `JSPForm` from XML.

[fromXML(Node, FormElement.InferFormElementCallback)](com/appiancorp/suiteapi/process/forms/DynamicForm.html#fromXML\(org.w3c.dom.Node,com.appiancorp.suiteapi.process.forms.FormElement.InferFormElementCallback\)) - Static method in class com.appiancorp.suiteapi.process.forms.[DynamicForm](com/appiancorp/suiteapi/process/forms/DynamicForm.html "class in com.appiancorp.suiteapi.process.forms")

[fromXML(Node, FormElement.InferFormElementCallback)](com/appiancorp/suiteapi/process/forms/FormConfig.html#fromXML\(org.w3c.dom.Node,com.appiancorp.suiteapi.process.forms.FormElement.InferFormElementCallback\)) - Static method in class com.appiancorp.suiteapi.process.forms.[FormConfig](com/appiancorp/suiteapi/process/forms/FormConfig.html "class in com.appiancorp.suiteapi.process.forms")

[fromXML(Node, FormElement.InferFormElementCallback)](com/appiancorp/suiteapi/process/forms/FormElement.html#fromXML\(org.w3c.dom.Node,com.appiancorp.suiteapi.process.forms.FormElement.InferFormElementCallback\)) - Static method in class com.appiancorp.suiteapi.process.forms.[FormElement](com/appiancorp/suiteapi/process/forms/FormElement.html "class in com.appiancorp.suiteapi.process.forms")

[frontEndTypedValue(TypedValue)](com/appiancorp/suiteapi/common/TypeConverter.html#frontEndTypedValue\(com.appiancorp.suiteapi.type.TypedValue\)) - Static method in class com.appiancorp.suiteapi.common.[TypeConverter](com/appiancorp/suiteapi/common/TypeConverter.html "class in com.appiancorp.suiteapi.common")

[frontEndTypedValue(Long, Object)](com/appiancorp/suiteapi/common/TypeConverter.html#frontEndTypedValue\(java.lang.Long,java.lang.Object\)) - Static method in class com.appiancorp.suiteapi.common.[TypeConverter](com/appiancorp/suiteapi/common/TypeConverter.html "class in com.appiancorp.suiteapi.common")

[Function](com/appiancorp/suiteapi/expression/Function.html "class in com.appiancorp.suiteapi.expression") - Class in [com.appiancorp.suiteapi.expression](com/appiancorp/suiteapi/expression/package-summary.html)

This class represents a function in the Expression Editor.

[Function](com/appiancorp/suiteapi/expression/annotations/Function.html "annotation interface in com.appiancorp.suiteapi.expression.annotations") - Annotation Interface in [com.appiancorp.suiteapi.expression.annotations](com/appiancorp/suiteapi/expression/annotations/package-summary.html)
...
[Function()](com/appiancorp/suiteapi/expression/Function.html#%3Cinit%3E\(\)) - Constructor for class com.appiancorp.suiteapi.expression.[Function](com/appiancorp/suiteapi/expression/Function.html "class in com.appiancorp.suiteapi.expression")

[Function(Function)](com/appiancorp/suiteapi/expression/Function.html#%3Cinit%3E\(com.appiancorp.suiteapi.expression.Function\)) - Constructor for class com.appiancorp.suiteapi.expression.[Function](com/appiancorp/suiteapi/expression/Function.html "class in com.appiancorp.suiteapi.expression")

[Function(String)](com/appiancorp/suiteapi/expression/Function.html#%3Cinit%3E\(java.lang.String\)) - Constructor for class com.appiancorp.suiteapi.expression.[Function](com/appiancorp/suiteapi/expression/Function.html "class in com.appiancorp.suiteapi.expression")

[FUNCTION\_CATEGORY\_KEY](com/appiancorp/suiteapi/rules/FreeformRule.html#FUNCTION_CATEGORY_KEY) - Static variable in class com.appiancorp.suiteapi.rules.[FreeformRule](com/appiancorp/suiteapi/rules/FreeformRule.html "class in com.appiancorp.suiteapi.rules")

[FUNCTION\_NOT\_AVAILABLE](com/appiancorp/suiteapi/common/exceptions/ErrorCode.html#FUNCTION_NOT_AVAILABLE) - Static variable in class com.appiancorp.suiteapi.common.exceptions.[ErrorCode](com/appiancorp/suiteapi/common/exceptions/ErrorCode.html "class in com.appiancorp.suiteapi.common.exceptions")

[FunctionCategory](com/appiancorp/suiteapi/expression/FunctionCategory.html "class in com.appiancorp.suiteapi.expression") - Class in [com.appiancorp.suiteapi.expression](com/appiancorp/suiteapi/expression/package-summary.html)

This class represents a function category in the Expression Editor.

[FunctionCategory()](com/appiancorp/suiteapi/expression/FunctionCategory.html#%3Cinit%3E\(\)) - Constructor for class com.appiancorp.suiteapi.expression.[FunctionCategory](com/appiancorp/suiteapi/expression/FunctionCategory.html "class in com.appiancorp.suiteapi.expression")

[FunctionCategory(FunctionCategory)](com/appiancorp/suiteapi/expression/FunctionCategory.html#%3Cinit%3E\(com.appiancorp.suiteapi.expression.FunctionCategory\)) - Constructor for class com.appiancorp.suiteapi.expression.[FunctionCategory](com/appiancorp/suiteapi/expression/FunctionCategory.html "class in com.appiancorp.suiteapi.expression")

[FunctionCategory(String)](com/appiancorp/suiteapi/expression/FunctionCategory.html#%3Cinit%3E\(java.lang.String\)) - Constructor for class com.appiancorp.suiteapi.expression.[FunctionCategory](com/appiancorp/suiteapi/expression/FunctionCategory.html "class in com.appiancorp.suiteapi.expression")

[FunctionCategory(String, List<Function>)](com/appiancorp/suiteapi/expression/FunctionCategory.html#%3Cinit%3E\(java.lang.String,java.util.List\)) - Constructor for class com.appiancorp.suiteapi.expression.[FunctionCategory](com/appiancorp/suiteapi/expression/FunctionCategory.html "class in com.appiancorp.suiteapi.expression")

[FunctionParameter](com/appiancorp/suiteapi/expression/FunctionParameter.html "class in com.appiancorp.suiteapi.expression") - Class in [com.appiancorp.suiteapi.expression](com/appiancorp/suiteapi/expression/package-summary.html)

This class represents a parameter of a function in the Expression Editor.

[FunctionParameter()](com/appiancorp/suiteapi/expression/FunctionParameter.html#%3Cinit%3E\(\)) - Constructor for class com.appiancorp.suiteapi.expression.[FunctionParameter](com/appiancorp/suiteapi/expression/FunctionParameter.html "class in com.appiancorp.suiteapi.expression")

[FunctionParameter(FunctionParameter)](com/appiancorp/suiteapi/expression/FunctionParameter.html#%3Cinit%3E\(com.appiancorp.suiteapi.expression.FunctionParameter\)) - Constructor for class com.appiancorp.suiteapi.expression.[FunctionParameter](com/appiancorp/suiteapi/expression/FunctionParameter.html "class in com.appiancorp.suiteapi.expression")

[FunctionParameter(Method, int, Name, Parameter, int)](com/appiancorp/suiteapi/expression/FunctionParameter.html#%3Cinit%3E\(java.lang.reflect.Method,int,com.appiancorp.suiteapi.common.Name,com.appiancorp.suiteapi.expression.annotations.Parameter,int\)) - Constructor for class com.appiancorp.suiteapi.expression.[FunctionParameter](com/appiancorp/suiteapi/expression/FunctionParameter.html "class in com.appiancorp.suiteapi.expression")

Create a FunctionParameter using a type id.

[FunctionParameter(Method, int, Name, Parameter, String)](com/appiancorp/suiteapi/expression/FunctionParameter.html#%3Cinit%3E\(java.lang.reflect.Method,int,com.appiancorp.suiteapi.common.Name,com.appiancorp.suiteapi.expression.annotations.Parameter,java.lang.String\)) - Constructor for class com.appiancorp.suiteapi.expression.[FunctionParameter](com/appiancorp/suiteapi/expression/FunctionParameter.html "class in com.appiancorp.suiteapi.expression")

Create a FunctionParameter using a name for the type of the parameter instead of a type id.

[FunctionRequest](com/appiancorp/suiteapi/expression/FunctionRequest.html "class in com.appiancorp.suiteapi.expression") - Class in [com.appiancorp.suiteapi.expression](com/appiancorp/suiteapi/expression/package-summary.html)

This class encapsulates a request by a user for a function to be evaluated.

[FunctionRequest()](com/appiancorp/suiteapi/expression/FunctionRequest.html#%3Cinit%3E\(\)) - Constructor for class com.appiancorp.suiteapi.expression.[FunctionRequest](com/appiancorp/suiteapi/expression/FunctionRequest.html "class in com.appiancorp.suiteapi.expression")