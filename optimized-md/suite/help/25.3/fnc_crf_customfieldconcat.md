---
source_url: https://docs.appian.com/suite/help/25.3/fnc_crf_customfieldconcat.html
original_path: fnc_crf_customfieldconcat.html
version: "25.3"
title: "a!customFieldConcat() Function"
page_id: "fnc_crf_customfieldconcat"
section: "Function"
...
The `a!customFieldConcat()` function can only be used to create a custom record field that evaluates in [real time](custom-record-fields.html#about-custom-record-fields). This means you can reference related record fields, constants, and other [supported functions](#supported-functions) in your calculations.
...
See the [Real-time evaluation recipes](custom-record-fields.html#real-time-evaluation-recipes) for more examples using this function.

## Supported functions

You can use any of the following supported functions in the _value_ parameter of `a!customFieldConcat()`:
